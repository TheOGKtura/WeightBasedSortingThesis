...
# picamera naka close lang sya if machine not started for power conservation
# connect firebase sa mga elements ng foods 
class CardWidget(QtWidgets.QFrame):
    clicked = QtCore.Signal(str, str, float)  # now also emits weight
...
class SearchBar(QtWidgets.QLineEdit):
    def focusInEvent(self, event):
        ...
        # Open Raspberry Pi’s onboard keyboard when focused
